function [H,x,min] = Powell(funkcja_celu, x0, eps,eps1)            
...
i = k;    % indeks wersora kierunkowego
    ...
    while true
        ...
        if i > k                    % gdy wszystkie kierunki zostały wykorzystane starujemy od nowa z
            i = 1;
            e_m(:,1) = [];                                   % usuwanie pierwszego wersora kierunkowego
            e_m(:,k) = H(iteracja,2)-H(iteracja-1,2);        % dodatnie nowego wersora kierunkowego
